...
export const MAX_CATALOG_TEXT_FONT_SIZE = 144;

/** Default styling when adding text on catalog / order images. */
export const DEFAULT_CATALOG_TEXT_FONT_SIZE = 72;
export const DEFAULT_CATALOG_TEXT_COLOR = '#FFCC00';
export const DEFAULT_CATALOG_TEXT_ALIGN: CatalogImageTextAlign = 'center';
export const DEFAULT_CATALOG_TEXT_POSITION = {nx: 0.5, ny: 0.5};
...
export const createCatalogImageTextLayerId = createCatalogTextLayerId;

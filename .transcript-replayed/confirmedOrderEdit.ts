...
import {pruneStudioOrderImageAnnotationData} from '@app/utils/orderAttachedImages';
...
export type ConfirmedOrderEditFields = Pick<
  ...
  | 'studioOrderImages'
  | 'studioOrderImageAnnotationData'
  | 'pieceCount'
  | 'collectedAmount'
  | 'subtotal'
  | 'discountAmount'
...
export function buildConfirmedOrderEditFields(params: {
  ...
  studioOrderImageAnnotationData?: CatalogMirrorImageAnnotationData;
  pieceCount: number;
  ...
  return {
    ...
    studioOrderImageAnnotationData: pruneStudioOrderImageAnnotationData(
      params.studioOrderImages ?? [],
      params.studioOrderImageAnnotationData,
    ) as CatalogMirrorImageAnnotationData | undefined,

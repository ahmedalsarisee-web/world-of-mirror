...
import {deleteUser, subscribeToUser} from '@app/services/users.service';
import {useAuthStore} from '@app/stores/authStore';
import type {AppUser} from '@app/types/models';
import type {EmployeeManagementStackParamList} from '@app/types/navigation';
import {canDeleteUser, canManageAdmins} from '@app/utils/adminPermissions';
...
const AdminDetailScreen: React.FC = () => {
  ...
  useEffect(() => {
    return subscribeToUser(userId, setAdmin);
  }, [userId]);
